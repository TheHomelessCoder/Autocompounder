...
contract AutoCompounder is Ownable, ReentrancyGuard {
    ...
    function emergencyWithdraw() external nonReentrant {
        ...
        ISmartChefInitializable(staker).withdraw(user.shares);
        IERC20Metadata(stakedToken).safeTransfer(address(msg.sender), user.shares);
    ...
    */
    ...
    function autoCompound() public {
        ...
        if (harvested == 0 || totalShares == 0) {return;}
